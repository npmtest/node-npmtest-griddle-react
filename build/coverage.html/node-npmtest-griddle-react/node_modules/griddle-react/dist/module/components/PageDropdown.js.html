...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-griddle-react/node_modules/griddle-react/dist/module/components/PageDropdown.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-griddle-react/node_modules/griddle-react/dist/module/components/PageDropdown.js</span></h1>
    <h2>
        
        Statements: <span class="metric">63.16% <small>(36 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-griddle-react/node_modules/griddle-react/dist/module/components/</a> &#187; PageDropdown.js</div>
</div>
<div class="body">
...
var getRange = <span class="fstat-no" title="function not covered" >function getRange(number) {</span>
<span class="cstat-no" title="statement not covered" >  if (!_lodash2.default.isFinite(number)) {</span>
<span class="cstat-no" title="statement not covered" >    return [0];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return Array(number).fill().map(<span class="fstat-no" title="function not covered" >function (_, i) {</span></span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function PageDropdown() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, PageDropdown);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PageDropdown.__proto__ || Object.getPrototypeOf(PageDropdown)).call.apply(_ref, [this].concat(args))), _this), _this.setPage = <span class="fstat-no" title="function not covered" >function (e) {</span></span>
<span class="cstat-no" title="statement not covered" >      _this.props.setPage(parseInt(e.target.value));</span>
...
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(</span>
        ...
        getRange(maxPages).map(<span class="fstat-no" title="function not covered" >function (num) {</span>
<span class="cstat-no" title="statement not covered" >          return _react2.default.createElement(</span>
            'option',
            { key: num, value: num },
            num
