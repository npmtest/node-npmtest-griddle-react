...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-griddle-react/node_modules/griddle-react/dist/module/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-griddle-react/node_modules/griddle-react/dist/module/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">53.57% <small>(60 / 112)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">32.2% <small>(19 / 59)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">31.82% <small>(7 / 22)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">59.7% <small>(40 / 67)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-griddle-react/node_modules/griddle-react/dist/module/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Griddle(props) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Griddle);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (Griddle.__proto__ || Object.getPrototypeOf(Griddle)).call(this, props));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _props$plugins = props.plugins,</span>
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >    var rowProperties = (0, _rowUtils.getRowProperties)(rowPropertiesComponent);</span>
<span class="cstat-no" title="statement not covered" >    var columnProperties = (0, _columnUtils.getColumnProperties)(rowPropertiesComponent);</span>
&nbsp;
    //Combine / compose the reducers to make a single, unified reducer
<span class="cstat-no" title="statement not covered" >    var reducers = (0, _compositionUtils.buildGriddleReducer)([dataReducers].concat(_toConsumableArray(plugins.map(<span class="fstat-no" title="function not covered" >function (p) {</span></span>
<span class="cstat-no" title="statement not covered" >      return p.reducer;</span>
    }))));
&nbsp;
    //Combine / Compose the components to make a single component for each component type
<span class="cstat-no" title="statement not covered" >    _this.components = (0, _compositionUtils.buildGriddleComponents)([_components2.default].concat(_toConsumableArray(plugins.map(<span class="fstat-no" title="function not covered" >function (p) {</span></span>
<span class="cstat-no" title="statement not covered" >      return p.components;</span>
    })), [userComponents]));
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.settingsComponentObjects = Object.assign.apply(Object, [{}, _settingsComponentObjects2.default].concat(_toConsumableArray(plugins.map(<span class="fstat-no" title="function not covered" >function (p) {</span></span>
<span class="cstat-no" title="statement not covered" >      return p.settingsComponentObjects;</span>
    })), [userSettingsComponentObjects]));
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.events = Object.assign.apply(Object, [{}, events].concat(_toConsumableArray(plugins.map(<span class="fstat-no" title="function not covered" >function (p) {</span></span>
<span class="cstat-no" title="statement not covered" >      return p.events;</span>
    }))));
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.selectors = plugins.reduce(<span class="fstat-no" title="function not covered" >function (combined, plugin) {</span></span>
<span class="cstat-no" title="statement not covered" >      return _extends({}, combined, plugin.selectors);</span>
    }, _extends({}, selectors));
&nbsp;
<span class="cstat-no" title="statement not covered" >    var mergedStyleConfig = _lodash2.default.merge({}, defaultStyleConfig, styleConfig);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var pageProperties = Object.assign({}, {</span>
      currentPage: 1,
      pageSize: 10
    }, importedPageProperties);
&nbsp;
    //TODO: This should also look at the default and plugin initial state objects
<span class="cstat-no" title="statement not covered" >    var renderProperties = Object.assign.apply(Object, [{</span>
      rowProperties: rowProperties,
      columnProperties: columnProperties
    }].concat(_toConsumableArray(plugins.map(<span class="fstat-no" title="function not covered" >function (p) {</span>
<span class="cstat-no" title="statement not covered" >      return p.renderProperties;</span>
    })), [userRenderProperties]));
&nbsp;
    // TODO: Make this its own method
<span class="cstat-no" title="statement not covered" >    var initialState = plugins.reduce(<span class="fstat-no" title="function not covered" >function (combined, plugin) {</span></span>
<span class="cstat-no" title="statement not covered" >      return !!plugin.initialState ? _extends({}, combined, plugin.initialState) : combined;</span>
    }, {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.store = (0, _redux.createStore)(reducers, initialState);</span>
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.store.dispatch(actions.updateState({ data: data, pageProperties: pageProperties, sortProperties: sortProperties }));</span>
    }
  }, {
    key: 'getChildContext',
